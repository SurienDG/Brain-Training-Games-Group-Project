...
Public Class frmChallenge2048
    ...
    Private Sub Form1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        If e.KeyCode = Keys.Right Then
            ...
            For Rows As Byte = 0 To 3
                ...
                If Tile(3, Rows) = Tile(2, Rows) And Tile(3, Rows) <> 11 And Tile(2, Rows) <> 11 Then
                    'increases the amount collected...sdg
                    If TileNumberToValue(Tile(3, Rows) + 1) = 8 Then
                        lbl8CollectedValue.Text += 1
                    ElseIf TileNumberToValue(Tile(3, Rows) + 1) = 16 Then
                        lbl16CollectedValue.Text += 1
                    End If
                ...
                ElseIf Tile(2, Rows) = Tile(1, Rows) And Tile(2, Rows) <> 11 And Tile(1, Rows) <> 11 Then
                    'increases the amount collected...sdg
                    If TileNumberToValue(Tile(2, Rows) + 1) = 8 Then
                        lbl8CollectedValue.Text += 1
                    ElseIf TileNumberToValue(Tile(2, Rows) + 1) = 16 Then
                        lbl16CollectedValue.Text += 1
                    End If
                    'increases the score...sdg
                ...
                ElseIf Tile(1, Rows) = Tile(0, Rows) And Tile(1, Rows) <> 11 And Tile(0, Rows) <> 11 Then
                    'increases the amount collected...sdg
                    If TileNumberToValue(Tile(1, Rows) + 1) = 8 Then
                        lbl8CollectedValue.Text += 1
                    ElseIf TileNumberToValue(Tile(1, Rows) + 1) = 16 Then
                        lbl16CollectedValue.Text += 1
                    End If
                    'increases the score...sdg
        ...
        ElseIf e.KeyCode = Keys.Left Then
            ...
            For Rows As Byte = 0 To 3
                ...
                If Tile(0, Rows) = Tile(1, Rows) And Tile(0, Rows) <> 11 And Tile(1, Rows) <> 11 Then
                    'increases the amount collected...sdg
                    If TileNumberToValue(Tile(0, Rows) + 1) = 8 Then
                        lbl8CollectedValue.Text += 1
                    ElseIf TileNumberToValue(Tile(0, Rows) + 1) = 16 Then
                        lbl16CollectedValue.Text += 1
                    End If
                    'increases the score...sdg
        ...
        ElseIf e.KeyCode = Keys.Up Then
            ...
            For Columns As Byte = 0 To 3
                ...
                If Tile(Columns, 0) = Tile(Columns, 1) And Tile(Columns, 0) <> 11 And Tile(Columns, 1) <> 11 Then
                    'increases the amount collected...sdg
                    If TileNumberToValue(Tile(Columns, 0) + 1) = 8 Then
                        lbl8CollectedValue.Text += 1
                    ElseIf TileNumberToValue(Tile(Columns, 0) + 1) = 16 Then
                        lbl16CollectedValue.Text += 1
                    End If
                    'increases the score...sdg
                ...
                ElseIf Tile(Columns, 1) = Tile(Columns, 2) And Tile(Columns, 1) <> 11 And Tile(Columns, 2) <> 11 Then
                    'increases the amount collected...sdg
                    If TileNumberToValue(Tile(Columns, 1) + 1) = 8 Then
                        lbl8CollectedValue.Text += 1
                    ElseIf TileNumberToValue(Tile(Columns, 1) + 1) = 16 Then
                        lbl16CollectedValue.Text += 1
                    End If
                    'increases the score...sdg
                ...
                ElseIf Tile(Columns, 2) = Tile(Columns, 3) And Tile(Columns, 2) <> 11 And Tile(Columns, 3) <> 11 Then
                    'increases the amount collected...sdg
                    If TileNumberToValue(Tile(Columns, 2) + 1) = 8 Then
                        lbl8CollectedValue.Text += 1
                    ElseIf TileNumberToValue(Tile(Columns, 2) + 1) = 16 Then
                        lbl16CollectedValue.Text += 1
                    End If
                    'increases the score...sdg
        ...
        ElseIf e.KeyCode = Keys.Down Then
            ...
            For Columns As Byte = 0 To 3
                ...
                If Tile(Columns, 3) = Tile(Columns, 2) And Tile(Columns, 3) <> 11 And Tile(Columns, 2) <> 11 Then
                    'increases the amount collected...sdg
                    If TileNumberToValue(Tile(Columns, 3) + 1) = 8 Then
                        lbl8CollectedValue.Text += 1
                    ElseIf TileNumberToValue(Tile(Columns, 3) + 1) = 16 Then
                        lbl16CollectedValue.Text += 1
                    End If
                    'increases the score...sdg
        ...
        If Moved = True Or Combined = True Then
            ...
            'subtracts one from moves left...sdg
            lblMovesLeftValue.Text -= 1
        End If
        'checks to see if user won the game...sdg
        If WinCheck() = True Or (lbl16TilesNeededValue.Text <= lbl16CollectedValue.Text And lbl8TilesNeededValue.Text <= lbl8CollectedValue.Text) Then
            ...
            If Response = 6 Then
                'creates a new instance of the form and closes the old one...sdg
                Dim frmChallenge2048 = New frmChallenge2048
            ...
            Else
                ...
                Me.Close()
            End If
            'checks to see if user lost the game...sdg
        ElseIf GameOverCheck() = True Or lblMovesLeftValue.Text = 0 Then
            'declares a variable for user response to exit check...sdg
            Dim Response As Byte
            'hides the current window and opens the exit form...sdg
    ...
    Private Sub AboutToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles mnuAbout.Click
        ...
        frmOverallSplash.LastForm = frmOverallSplash.Challenge2048
        Me.Hide()
        frmAbout.Show()
    End Sub
    ...
    Private Sub InstructionsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles mnuInstructions.Click
        ...
        MsgBox("To play this game move tiles using the arrow keys to combine like tiles till you get the desired ones. If the board fills up before you get one you lose. Good luck!", 64, "Intructions")
    End Sub

    Private Sub MainMenuToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles mnuMainMenu.Click

        'shows the main splash screen and closes current window...sdg
    ...
    Private Sub SelectorToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles mnuSelector.Click
        'creates a new instance of the form and closes the old one and goes to forms not available in the tabs at the top...sdg
        ...
        'creates a new instance of the form and closes the old one...sdg
        'and goes wherever the user entered they wanted to go...sdg
