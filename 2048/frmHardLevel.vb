...
Public Class frmHardLevel
    ...
    Private Sub frmGame_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        fileReader = My.Computer.FileSystem.ReadAllText(Application.StartupPath & "\WordsForGameHard.txt")
        ...
        For Each character As Char In fileReader
            If AscW(character) = 32 Then
                For counter3 As Integer = counter1 + 1 To Len(fileReader) - 1
